...
const page = () => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      console.log("Response from API:", apiData["url"]);
      const link = document.createElement('a');
      link.href = apiData["url"];
      link.download = 'downloaded_file.png'; // Set the desired file name
      link.click();
      setShowModal(false);
      document.body.removeChild(link);
          ...
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-0">
            <div className="text-center">
              <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">
                <span className="text-blue-500 pl-20">Landslide Detection</span>
              </h1>
            </div>
            {showModal && (
              <div
            ...
            <div className="m-auto w-screen md:w-[100vh] ">
              <div className=" py-10  lg:py-14 mx-auto mx-12">
                <div className="ml-36 py-14 space-y-12">
            ...
            <div
              className="hidden absolute top-2/4 start-0 transform -translate-y-2/4 -translate-x-40 md:block lg:-translate-x-60"
              aria-hidden="true"
            >
              <svg
            ...
            <div
              className="hidden absolute top-2/4 end-0 transform -translate-y-2/4 translate-x-60 md:block lg:translate-x-[500px]"
              aria-hidden="true"
            >
              <svg
