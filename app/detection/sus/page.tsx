...
const page = () => {
    ...
    const handleCreateMapClick = async (event) => {
        ...
        try {
            toggleModal();
            const response = await fetch('http://127.0.0.1:8000/susmap', {
                method: 'POST',
                body: formData,
            });
            ...
            console.log('Response from /susmap:', data);
            ...
            downloadLink.href = data.map;

            // Specify the download attribute and the desired file name
            downloadLink.download = 'downloaded_file.zip';
                    ...
                    <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-0">
                        <div className="text-center">
                            ...
                            <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">
                                <span className="text-blue-500 pl-20">Susceptibility</span>
                            </h1>
                        </div>
                        {showModal && (
                            <div className="fixed top-0 left-0 z-50 w-screen h-screen flex items-center justify-center" style={{ background: 'rgba(0, 0, 0, 0.3)' }}>
                                <div className="bg-white border py-12 px-5 rounded-lg flex items-center flex-col">
                                    <div className="text-gray-500 text-lg font-medium mt-2 text-center">
                                        Creating The Map, Please Be Patient.....
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        <div className='m-auto w-screen md:w-[100vh] '>
                            <div className=" py-10  lg:py-14 mx-auto mx-12">
                                <form className='ml-36 py-14 space-y-12'>
                                    <label className="block">
                                        <span className="sr-only">Choose profile photo</span>
                                        <input type="file" ref={fileInputRef} id='input_files' className="block w-full text-sm text-gray-500
    ...
    " multiple={true} />
                                    ...
                                    <button
                                        ...
                                        className="bg-[#2563EB] w-8/12 lg:w-full py-4 rounded-lg hover:bg-blue-700 text-white"
                                    >
                                        Create Map
                                    </button>
                                </form>
