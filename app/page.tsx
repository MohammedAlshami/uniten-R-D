  ...
  return (
    <>
      <div className='flex h-screen bg-gray-200'>
          <main className="w-full max-w-md m-auto p-6">
            <div className="mt-7 shadow-xl  bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
