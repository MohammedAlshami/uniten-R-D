  ...
  return (
    <>
      <div className="overflow-hidden">
        ...
        <div className="max-w-[85rem] mx-auto py-20">
            ...
            <div className="m-auto w-screen md:w-[100vh]">
              <div className=" py-10  lg:py-14 mx-auto mx-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Link href="/detection/landslide">
                    <div className="transition ease-in-out delay-150 duration-300  hover:-translate-y-1 hover:scale-110 cursor-pointer hover:shadow-2xl shadow-lg h-36 sm:h-56 flex flex-col justify-center border border-gray-200 rounded-xl text-center p-4 md:p-5 dark:border-gray-700">
                  ...
                  <Link href="#">
                    <div className="bg-gray-400 transition ease-in-out delay-150 duration-300  hover:-translate-y-1 hover:scale-110 cursor-pointer hover:shadow-2xl shadow-lg h-36 sm:h-56 flex flex-col justify-center border border-gray-200 rounded-xl text-center p-4 md:p-5 dark:border-gray-700">
                      <div className="flex justify-center items-center w-12 h-12 rounded-lg mx-auto">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="p-2"
                          viewBox="0 0 14 14"
                        >
                          <g
                            ...
                            strokeLinejoin="round"
                          >
                            <path d="M7.89 1.05a1 1 0 0 0-1.78 0l-5.5 11a1 1 0 0 0 .89 1.45h11a1 1 0 0 0 .89-1.45z"></path>
                            <path d="m6.696 10.969l2.022-2.767H5.281l2.022-2.766"></path>
                          </g>
                        </svg>{" "}
                      </div>

                      <div className="mt-3">
                        <h3 className="text-sm sm:text-lg font-semibold text-gray-200 dark:text-gray-200">
                          Damage Assessment
                        </h3>
                      </div>
                    </div>
